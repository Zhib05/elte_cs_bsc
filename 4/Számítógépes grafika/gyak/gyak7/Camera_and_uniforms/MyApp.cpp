...
void CMyApp::InitGeometry()
{
	...
	meshCPU.vertexArray = 
	{
		...
		{ glm::vec3( 0,  sqrt(2.0f), 0),	 glm::vec3(0, 1, 0)}
	};

	meshCPU.indexArray =
	{
		// Alaplap (teglalap két háromszögre bontva)
		0, 1, 2,
		1, 3, 2,
		// Sides (háromszögek a csúcs felé)
		4, 2, 3, // +Z
		4, 3, 1, // +X
		4, 1, 0, // -Z
		4, 0, 2 // -X
...
void CMyApp::Update( const SUpdateInfo& updateInfo )
{
	...
	//m_camera.SetView(
	//	glm::vec3(cos(m_ElapsedTimeInSec) * 5.f, 0.f, sinf(m_ElapsedTimeInSec) * 5.f),   // honnan nézzük a színteret  - eye
	//	glm::vec3(0.0, 0.0, 0.0),   // a színtér melyik pontját nézzük  - at
	//	glm::vec3(0.0, 1.0, 0.0));  // felfelé mutató irány a világban  - up
}
