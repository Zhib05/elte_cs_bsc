...
namespace Malom.Test
{
    ...
    public class GameModelTest
    {
        ...
        /// <summary>
        /// Teszt inicializálása minden egyes teszt előtt.
        /// </summary>
        [TestInitialize]
        ...
        /// <summary>
        /// Új játék inicializációs tesztje.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Érvényes lépések a lerakó fázisban.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Érvénytelen lépések a lerakó fázisban.
        /// </summary>
        [TestMethod]
        public void InvalidPlacingPhaseTest()
        {
            _model.MakeMove(0);
            _model.MakeMove(0);
        ...
        /// <summary>
        /// Malom kialakulásának tesztje.
        /// </summary>
        [TestMethod]
        public void MalomFormationTest()
        {
            // Helyezés
        ...
        /// <summary>
        /// Bábu eltávolításának tesztje malom után.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Érvénytelen saját bábu eltávolítása malom után.
        /// </summary>
        [TestMethod]
        public void InvalidRemovalOwnTest()
        {
            _model.MakeMove(0); // Player1
            _model.MakeMove(1); // Player2
            _model.MakeMove(4); // Player1
        ...
        /// <summary>
        /// Érvénytelen üres helyről történő eltávolítás malom után.
        /// </summary>
        [TestMethod]
        public void InvalidRemovalEmptyTest()
        {
            _model.MakeMove(0); // Player1
            _model.MakeMove(1); // Player2
            _model.MakeMove(4); // Player1
        ...
        /// <summary>
        /// Érvénytelen malomban lévő bábu eltávolítása.
        /// </summary>
        [TestMethod]
        public void InvalidRemovalMalomTest()
        {
            _model.MakeMove(0); // Player1
            _model.MakeMove(1); // Player2
            _model.MakeMove(4); // Player1
        ...
        /// <summary>
        /// Érvényes mozgás a mozgó fázisban.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Érvénytelen mozgás a mozgó fázisban: nem szomszédos helyre és foglalt helyre.
        /// </summary>
        [TestMethod]
        public void InvalidMoveToNotNeighborsAndOccupiedTest()
        {
            _model.MakeMove(0); // Player1
            _model.MakeMove(12); // Player2
            _model.MakeMove(4); // Player1
            ...
            _model.MakeMove(0); // Kiválasztás (Player1)
            _model.MakeMove(7); // Mozgatás (Player1)
            Assert.AreEqual(1, _invalidActionCount);
            Assert.AreEqual(Player.Player1, _model.CurrentPlayer);

            // Érvénytelen mozgás: szomszédos hely foglalt
            _model.MakeMove(0); // Kiválasztás (Player1)
            _model.MakeMove(4); // Mozgatás (Player1)
            Assert.AreEqual(2, _invalidActionCount);
            Assert.AreEqual(Player.Player1, _model.CurrentPlayer);
        }

        /// <summary>
        /// Játék vége feltételek tesztje.
        /// </summary>
        [TestMethod]
