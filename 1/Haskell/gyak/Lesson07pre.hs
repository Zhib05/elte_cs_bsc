...
sumDifferentFruits batches = helper batches (0,0,0) where
  ...
  helper (FruitBatch Apple x : bs) (apples, grapes, pear) = helper bs (apples + x, grapes, pear)
  helper (FruitBatch Grape x : bs) (apples, grapes, pear) = helper bs (apples, grapes + x, pear)
  helper (FruitBatch Pear x : bs) (apples, grapes, pear) = helper bs (apples, grapes, pear + x)
